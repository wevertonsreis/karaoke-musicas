...
public class ListaMusicasTodasFragment extends Fragment {

    private MusicaAdapter musicaAdapter;

    public ListaMusicasTodasFragment(MusicaAdapter musicaAdapter) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_musicas_todas, container, false);
